...
using BattlestaHealthChecks.Jobs;
using BattlestaHealthChecks.Mapper;
using BattlestaHealthChecks.Services;
using BattlestaHealthChecks.Workers;
...
namespace BattlestaHealthChecks
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ICheckWeb, CheckWeb>();
            services.AddTransient<ICreateBackup, CreateBackup>();
            services.AddTransient<ISampleService, SampleService>();
            services.AddTransient<ISampleSettingsService, SampleSettingsService>();
            //services.AddHostedService<CheckBattlesta>();
            //services.AddHostedService<BattlestaBackup>();
